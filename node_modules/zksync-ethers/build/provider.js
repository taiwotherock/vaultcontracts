...
const Il2AssetRouterFactory_1 = require("./typechain/Il2AssetRouterFactory");
...
class Provider extends ethers_1.ethers.providers.JsonRpcProvider {
    ...
    static getFormatter() {
        if (!defaultFormatter) {
            ...
            defaultFormatter.formats.block.sealFields = Formatter.allowNull(Formatter.arrayOf(data));
    ...
    async l2TokenAddress(token, bridgeAddress) {
        ...
        bridgeAddress !== null && bridgeAddress !== void 0 ? bridgeAddress : (bridgeAddress = (await this.getDefaultBridgeAddresses()).sharedL2);
    ...
    async getBaseTokenContractAddress() {
        ...
        return ethers_1.ethers.utils.getAddress(this.contractAddresses.baseToken);
    }
    /**
    ...
    async connectL2Bridge(address) {
        if (await this.isL2BridgeLegacy(address)) {
            return Il2BridgeFactory_1.Il2BridgeFactory.connect(address, this);
        }
        return Il2SharedBridgeFactory_1.Il2SharedBridgeFactory.connect(address, this);
    }
    connectL2AssetRouter() {
        return Il2AssetRouterFactory_1.Il2AssetRouterFactory.connect(utils_1.L2_ASSET_ROUTER_ADDRESS, this);
    }
    /**
    ...
    async isL2BridgeLegacy(address) {
        const bridge = Il2SharedBridgeFactory_1.Il2SharedBridgeFactory.connect(address, this);
        try {
    ...
    _prepareFilter(filter) {
        return {
            ...filter,
            fromBlock: filter.fromBlock === null || filter.fromBlock === undefined
                ? null
                : this.formatter.blockTag(filter.fromBlock),
            toBlock: filter.fromBlock === null || filter.fromBlock === undefined
                ? null
    ...
    async _getPriorityOpConfirmationL2ToL1Log(txHash, index = 0) {
        const hash = ethers_1.ethers.utils.hexlify(txHash);
    ...
    return function (method, params) {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.emit('debug', {
                action: 'request',
                fetcher,
                request: (0, utils_2.deepCopy)(request),
                // @ts-ignore
                provider: this,
            });
...
class Web3Provider extends Provider {
    ...
    constructor(provider, network) {
        ...
        super(path, network);
        this.jsonRpcFetchFunc = jsonRpcFetchFunc;
    ...
    async send(method, params) {
        ...
        return await this.jsonRpcFetchFunc(method, params);
    }
    /**
