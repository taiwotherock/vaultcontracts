 ...
 * @readonly
 */
export declare const L2_MESSAGE_VERIFICATION_ABI: ethers.utils.Interface;
/**
 * The ABI for the `L2InteropRootStorage` interface.
 * @readonly
 */
export declare const L2_INTEROP_ROOT_STORAGE_ABI: ethers.utils.Interface;
/**
 ...
 * @readonly
 */
export declare const L2_MESSAGE_VERIFICATION_ADDRESS: Address;
/**
 * The address of the L2 Interop Root Storage.
 * @readonly
 */
export declare const L2_INTEROP_ROOT_STORAGE_ADDRESS: Address;
/**
