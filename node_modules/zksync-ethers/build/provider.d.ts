...
export declare class Provider extends ethers.providers.JsonRpcProvider {
     ...
     */
    getLogProof(txHash: BytesLike, index?: number, interopMode?: InteropMode): Promise<MessageProof | null>;
    /**
...
export declare class Web3Provider extends Provider {
     ...
     */
    constructor(provider: ExternalProvider | JsonRpcFetchFunc, network?: ethers.providers.Networkish);
    /**
     * @inheritDoc
     *
     * @example
